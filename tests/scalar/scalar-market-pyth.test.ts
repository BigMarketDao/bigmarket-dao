...
import { alice, betty, bob, constructDao, deployer, marketScalingCPMM, metadataHash, passProposalByCoreVote, reputationSft, stxToken, tom } from '../helpers';
...
describe('claiming errors', () => {
	...
	// 	let response = await claim(alice, 0, 10006);
