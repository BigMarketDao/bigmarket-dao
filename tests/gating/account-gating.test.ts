...
describe('gating market  creation', () => {
	...
	it('GENERATE TESTNET MERKLE ROOTS FOR MARKET CREATION', async () => {
		...
		console.log(
			'ST2TQ069HEM31JMBNSMBP7MQDKDTB56F6M0AKT00W, ST2XHA15V40FAP9QZ0KMR7KBZ4NREV937QHZNT6B4, ST167Z6WFHMV0FZKFCRNWZ33WTB0DFBCW9M1FW3AY, ST105HCS1RTR7D61EZET8CWNEF24ENEN3V6ARBYBJ, ST3SJD6KV86N90W0MREGRTM1GWXN8Z91PF6W0BQKM, STQE3J7XMMK0DN0BWJZHGE6B05VDYQRXRNM0T1J8, ST2RNHHQDTHGHPEVX83291K4AQZVGWEJ7WD7SDHD8 '
		);
		console.log('--------------------------------------------------------------------------------------------------------------');
		console.log(
		...
		allowedCreators = [
			...
			'SP2XHA15V40FAP9QZ0KMR7KBZ4NREV937QH668MB9',
